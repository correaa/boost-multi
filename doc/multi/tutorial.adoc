...
There are many challenges in implementing more powerful and general expressions:
...
There is no single way to implement lazy operations; it depends on the intended use.
