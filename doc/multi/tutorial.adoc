...
In the same way, for lambdas that capture references, the validity of the restriction objects would be contigent to the lifetime of these references.
Analogously if the lambda captures by copy, the implications of copying these must be evaluated too.
