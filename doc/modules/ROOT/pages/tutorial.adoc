...
These are, in principle, separate C++ variables.
...
Finally, each dimension (e.g., 1D, 2D, 3D) would need to be explicitly code and the relation between a subarray of lower dimensionality and the main array would be opaque.
