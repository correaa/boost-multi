...
Problems such are deep assignment, or const-propagation are not fully solved, and ownership is delegated to a separte `std::mdarray` (proposed for C{plus}{plus}26).
