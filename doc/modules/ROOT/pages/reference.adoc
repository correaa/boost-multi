...
| `multi::array_ref<T, D>`          | Static         | Dynamic/Immutable              | Any  (doesn't allocate)             | No, (pinned)                         | "array-reference"                               | Use existing buffers (e.g. from other libs)
...
| `multi::subarray<T, D>`           | Static         | Dynamic/Immutable              | Any  (doesn't allocate)             | No, (pinned)                         | "subarray", "subarray-reference"                | As a reference, implicitly used through `auto` or template, prevent code bloat across compilation boundaries
| `multi::restriction<D, F>`        | Static         | Dynamic/Immutable              | None (doesn't allocate)             | None                                 | "restriction", "lazy array", "array expression" | Use once, build expressions, pass functions as if they were array refences to generic algorithms 
|===
