...
Finally `multi::inplace_array` is a template especialization of `multi::array` that uses a internal stack-based allocator; this guarantees total interface compatibility with `multi::array`.
