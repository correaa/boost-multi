...
This section is an conceptual overview of the system of types, if you want to read the API interface as coded, please visit the xref:reference:index.adoc[API documentation page].
