...
NOTE: As of Sep 2026, converting a nested Python list directly into a bidimensional array (e.g. `multi.array['double', 2]([[1.0, 2.0], [3.0, 4.0]])`) crashes the Python interpreter; as a workaround, construct from extensions and assign the elements instead.
