...
Element access             & \lstinline|A[i,j]|                       & \lstinline|A[i][j]| or \lstinline|A(i,j)| \\
...
Copy                       & \lstinline|B = A[0:2].copy()|            & \lstinline|multi::array<double,2> B = A({0,2});| or \lstinline|auto B =+ A({0, 2});| \\
