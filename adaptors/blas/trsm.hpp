...
-> decltype(auto) try{
	...
	throw std::logic_error{
		"couldn't do "+std::string(__PRETTY_FUNCTION__)+" of layout a_side="+ static_cast<char>(a_side) +" a_fill="+ static_cast<char>(a_fill) +" a_diag="+ static_cast<char>(a_diag) +" alpha=xx"
