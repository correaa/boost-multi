...
namespace fft{
	...
	template<class In, class... Args> auto dft(std::array<bool, std::decay_t<In>::rank_v> which, In&& in, Args&&... args) DECLRETURN(dft_aux_(priority<1>{}, which, std::forward<In>(in), std::forward<Args>(args)...))
	...
	template<class In, class... Args> auto dft_forward(std::array<bool, std::decay_t<In>::rank_v> which, In&& in, Args&&... args) DECLRETURN(dft_forward_aux_(priority<1>{}, which, std::forward<In>(in), std::forward<Args>(args)...))
	...
	template<class In, class... Args> auto dft_backward(std::array<bool, std::decay_t<In>::rank_v> which, In&& in, Args&&... args) DECLRETURN(dft_backward_aux_(priority<1>{}, which, std::forward<In>(in), std::forward<Args>(args)...))
