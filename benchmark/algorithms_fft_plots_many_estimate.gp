...
# The standard five-plot report uses the deeper howmany=256 case.
...
# plan construction and input restoration are excluded; both execute in place.
...
set title "In-place generalized-many {none,forward}, howmany=256 — multi::fft\\_plan vs FFTW 3 (cold cache, ESTIMATE)"
...
set title "In-place generalized-many {none,forward,forward}, depth=32 — multi::fft\\_plan vs FFTW 3 (cold cache, ESTIMATE)"
