...
set title "1-D complex FFT — multi::fft\\_plan vs FFTW 3 (plan recycled, wisdom DISABLED, MEASURE)"
...
set title "2-D complex FFT (n × n) — multi::fft\\_plan vs FFTW 3 (plan recycled, wisdom DISABLED, MEASURE)"
...
set title "3-D complex FFT (n × n × n) — multi::fft\\_plan vs FFTW 3 (plan recycled, wisdom DISABLED, MEASURE)"
