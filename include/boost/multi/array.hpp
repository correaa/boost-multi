...
struct array : static_array<T, D, Alloc> {
	...
	array(typename array::extensions_type exts, typename array::allocator_type const& alloc) : static_array<T, D, typename array::allocator_type>{exts, alloc} {}  // needed by MSVC?
