...
#endif
#if defined(__NVCC__) || defined(__NVCOMPILER) || !defined(_MSC_VER) // TODO(correaa) maybe needs to skip this for MSVC
	constexpr transform_ptr() : p_{}, f_{reinterpret_cast<UF&>(p_)} { assert(0); }  // should never be called, this is to fulfil a concept
#else
#ifdef _MSC_VER
#pragma warning(push)
