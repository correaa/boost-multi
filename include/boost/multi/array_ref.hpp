...
#pragma warning(disable : 4820)  //'boost::multi::subarray_ptr<double,1,fancy::ptr<double>,boost::multi::layout_t<1,boost::multi::size_type>,true>': '7' bytes padding added after data member 'boost::multi::subarray_ptr<double,1,fancy::ptr<double>,boost::multi::layout_t<1,boost::multi::size_type>,true>::base_'
	...
	ElementPtr                                                 base_;
	typename std::iterator_traits<ElementPtr>::difference_type offset_;  // always a plain integer (unlike base_): zero-cost to keep well-defined through subarray_ptr()'s defaulted default constructor
...
#pragma clang diagnostic pop
 ...
 public:
	...
	BOOST_MULTI_HD constexpr subarray_ptr(std::nullptr_t nil) : layout_{}, base_{nil} {}  // NOLINT(google-explicit-constructor,hicpp-explicit-conversions,cppcoreguidelines-explicit-constructor,misc-explicit-constructor) terse syntax and functionality by default
