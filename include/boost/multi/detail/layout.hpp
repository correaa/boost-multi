...
#include "boost/multi/detail/index_range.hpp"    // for index_extension, extension_t, tuple, intersection, range, operator!=, operator==  // IWYU pragma: export
...
#include "boost/multi/detail/tuple_zip.hpp"      // for get, tuple, tuple_prepend, tail, tuple_prepend_t, ht_tuple  // IWYU pragma: export
