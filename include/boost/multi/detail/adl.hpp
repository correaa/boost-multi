...
#pragma nv_diag_suppress = 20011  // deep inside Thrust: calling a __host__ function from a __host__ __device__ function (e.g. uninitialized_copy_functor with std::string/std::vector)
