...
#define BOOST_MULTI_DECLRET(ExpR) -> decltype(ExpR) {return ExpR;}  // NOLINT(cppcoreguidelines-macro-usage) saves a lot of typing
#define BOOST_MULTI_JUSTRET(ExpR)                   {return ExpR;}  // NOLINT(cppcoreguidelines-macro-usage) saves a lot of typing
...
#if defined(__NVCC__) || defined(__HIP_PLATFORM_NVIDIA__) || defined(__HIP_PLATFORM_AMD__) || defined(__HIPCC__)
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(         ::thrust::copy(std::forward<As>(args)...))
#endif
	template<         class... As> constexpr auto _(priority<3>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                   copy(std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::copy(std::forward<T>(arg), std::forward<As>(args)...))
//  template<class... As         > constexpr auto _(priority<5>/**/,          As&&... args) const BOOST_MULTI_DECLRET(boost::multi::adl_custom_copy<std::decay_t<As>...>::copy(std::forward<As>(as)...))
	template<class T, class... As> constexpr auto _(priority<6>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).copy(std::forward<As>(args)...))
...
namespace adl {
	...
	class fill_t {
		template<class... As>          auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(              std::  fill              (std::forward<As>(args)...))
		template<class... As>          auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     fill              (std::forward<As>(args)...))
		template<class T, class... As> auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).fill              (std::forward<As>(args)...))
		// template<class... As>          auto _(priority<4>/**/,          As&&... args) const BOOST_MULTI_DECLRET(custom::             fill_t<As&&...>::_(std::forward<As>(args)...))
	
	 public:
		template<class... As> auto operator()(As&&... args) const BOOST_MULTI_DECLRET(_(priority<5>{}, std::forward<As>(args)...))
	};
...
class adl_uninitialized_copy_n_t {
	...
	template<class T, class... As> constexpr auto _(priority<5>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).uninitialized_copy_n(std::forward<As>(args)...))

 public:
	template<class... As> constexpr auto operator()(As&&... args) const BOOST_MULTI_DECLRET(_(priority<5>{}, std::forward<As>(args)...))  // TODO(correaa) this might trigger a compiler crash with g++ 7.5 because of operator&() && overloads
};
...
class adl_uninitialized_move_n_t {
	template<class... As>          constexpr auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(              std::  uninitialized_move_n(std::forward<As>(args)...))
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     uninitialized_move_n(std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::decay_t<T>::    uninitialized_move_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).uninitialized_move_n(std::forward<As>(args)...))
...
class adl_distance_t {
 ...
 public:
	template<class... As> constexpr auto operator()(As&&... args) const BOOST_MULTI_DECLRET(_(priority<5>{}, std::forward<As>(args)...))
};
}  // end namespace adl
...
// #endif
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(    std::decay_t<T>::begin(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).begin(std::forward<As>(args)...))

 public:
	template<class... As> [[nodiscard]] constexpr auto operator()(As&&... args) const BOOST_MULTI_DECLRET(_(priority<4>{}, std::forward<As>(args)...))
};
...
// #endif
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  end(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).end(std::forward<As>(args)...))
...
class adl_size_t {
	template<class... As>          constexpr auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                std::size(std::forward<As>(args)...))
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     size(std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(    std::decay_t<T>::size(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).size(std::forward<As>(args)...))
...
class adl_swap_ranges_t {
	template<class... As>          constexpr auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(              std::  swap_ranges(std::forward<As>(args)...))
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     swap_ranges(std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  swap_ranges(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).swap_ranges(std::forward<As>(args)...))
...
class adl_lexicographical_compare_t {
	template<class... As>          constexpr auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(              std::  lexicographical_compare(std::forward<As>(args)...))
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     lexicographical_compare(std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  lexicographical_compare(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).lexicographical_compare(std::forward<As>(args)...))
...
class adl_uninitialized_value_construct_n_t {
	template<class... As>              constexpr auto _(priority<1>/**/,                      As&&... args) const BOOST_MULTI_DECLRET(              std::  uninitialized_value_construct_n(std::forward<As>(args)...))  // TODO(correaa) use boost alloc_X functions?
	template<class... As>              constexpr auto _(priority<2>/**/,                      As&&... args) const BOOST_MULTI_DECLRET(                     uninitialized_value_construct_n(std::forward<As>(args)...))
	template<class T, class... As>     constexpr auto _(priority<3>/**/, T&& arg,             As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::uninitialized_value_construct_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As>     constexpr auto _(priority<4>/**/, T&& arg,             As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).uninitialized_value_construct_n(std::forward<As>(args)...))
...
class adl_alloc_uninitialized_value_construct_n_t {
	template<class Alloc, class... As> constexpr auto _(priority<1>/**/, Alloc&& /*alloc*/, As&&... args) const BOOST_MULTI_DECLRET(                       adl_uninitialized_value_construct_n(std::forward<As>(args)...))  // NOLINT(cppcoreguidelines-missing-std-forward)
//  template<class... As>              constexpr auto _(priority<2>/**/,                    As&&... args) const BOOST_MULTI_DECLRET(              xtd::  alloc_uninitialized_value_construct_n(std::forward<As>(args)...))  // TODO(correaa) use boost alloc_X functions?
	template<class... As>              constexpr auto _(priority<3>/**/,                    As&&... args) const BOOST_MULTI_DECLRET(                     alloc_uninitialized_value_construct_n(std::forward<As>(args)...))
	template<class T, class... As>     constexpr auto _(priority<4>/**/, T&& arg,           As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  alloc_uninitialized_value_construct_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As>     constexpr auto _(priority<5>/**/, T&& arg,           As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).alloc_uninitialized_value_construct_n(std::forward<As>(args)...))
...
class adl_uninitialized_default_construct_n_t {
	...
	// #endif
	template<class... As>          constexpr auto _(priority<3>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     uninitialized_default_construct_n(                      std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  uninitialized_default_construct_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<5>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).uninitialized_default_construct_n(                      std::forward<As>(args)...))
...
class adl_alloc_uninitialized_default_construct_n_t {
	template<class Alloc, class... As>          constexpr auto _(priority<1>/**/, Alloc&&/*unused*/, As&&... args) const BOOST_MULTI_JUSTRET(                      adl_uninitialized_default_construct_n(                      std::forward<As>(args)...))  // NOLINT(cppcoreguidelines-missing-std-forward)
	template<class... As>                       constexpr auto _(priority<2>/**/,                    As&&... args) const BOOST_MULTI_DECLRET(               xtd::alloc_uninitialized_default_construct_n(                      std::forward<As>(args)...))  // TODO(correaa) use boost alloc_X functions?
#if defined(__CUDACC__) || defined(__HIPCC__)
#if defined(THRUST_VERSION) && (THRUST_VERSION < 200700)  // 200800)
	// boost::multi::detail::what_value_t<THRUST_VERSION> a;
	template<class Alloc, class It, class Size> constexpr auto _(priority<3>/**/, Alloc&& alloc, It first, Size n) const BOOST_MULTI_DECLRET(         (thrust::detail::default_construct_range(std::forward<Alloc>(alloc), first, n)) )
#else
	// boost::multi::detail::what_value_t<THRUST_VERSION> b;
	template<class Alloc, class It, class Size> constexpr auto _(priority<3>/**/, Alloc&& alloc, It first, Size n) const BOOST_MULTI_DECLRET(         (thrust::detail::value_initialize_range(std::forward<Alloc>(alloc), first, n)) )
#endif
#endif
	template<class... As>                       constexpr auto _(priority<4>/**/,          As&&... args          ) const BOOST_MULTI_DECLRET(                     alloc_uninitialized_default_construct_n(                      std::forward<As>(args)...))  
	template<class T, class... As>              constexpr auto _(priority<5>/**/, T&& arg, As&&... args          ) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  alloc_uninitialized_default_construct_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As>              constexpr auto _(priority<6>/**/, T&& arg, As&&... args          ) const BOOST_MULTI_DECLRET(std::forward<T>(arg).alloc_uninitialized_default_construct_n(                      std::forward<As>(args)...))
...
class adl_destroy_n_t {
	template<class... As>          constexpr auto _(priority<1>/**/,          As&&... args) const BOOST_MULTI_DECLRET(            multi::  destroy_n              (std::forward<As>(args)...))
	template<class... As>          constexpr auto _(priority<2>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     destroy_n              (std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<3>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(  std::decay_t<T>::  destroy_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As> constexpr auto _(priority<4>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).destroy_n              (std::forward<As>(args)...))
...
#if defined(__NVCC__) || defined(__HIP_PLATFORM_NVIDIA__) || defined(__HIP_PLATFORM_AMD__) || defined(__HIPCC__)
	template<class Alloc, class It, class Size> constexpr auto _(priority<2>/**/, Alloc& alloc, It first, Size n) const BOOST_MULTI_DECLRET(   (thrust::detail::destroy_range(alloc, first, first + n)))
#endif
	template<             class... As> constexpr auto _(priority<3>/**/,          As&&... args) const BOOST_MULTI_DECLRET(multi::              alloc_destroy_n              (std::forward<As>(args)...))  // TODO(correaa) use boost alloc_X functions?
	template<             class... As> constexpr auto _(priority<4>/**/,          As&&... args) const BOOST_MULTI_DECLRET(                     alloc_destroy_n              (std::forward<As>(args)...))
	template<class T,     class... As> constexpr auto _(priority<5>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::decay_t<T>::    alloc_destroy_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T,     class... As> constexpr auto _(priority<6>/**/, T&& arg, As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).alloc_destroy_n              (std::forward<As>(args)...))
...
class adl_alloc_uninitialized_copy_t {
	...
	template<class Alloc, class... As> constexpr auto _(priority<2>/**/, Alloc&& alloc, As&&... args) const BOOST_MULTI_DECLRET(                      xtd::alloc_uninitialized_copy(std::forward<Alloc>(alloc), std::forward<As>(args)...))
	template<class Alloc, class... As> constexpr auto _(priority<3>/**/, Alloc&& alloc, As&&... args) const BOOST_MULTI_DECLRET(                           alloc_uninitialized_copy(std::forward<Alloc>(alloc), std::forward<As>(args)...))
	template<class Alloc, class... As> constexpr auto _(priority<4>/**/, Alloc&& alloc, As&&... args) const BOOST_MULTI_DECLRET(      std::decay_t<Alloc>::alloc_uninitialized_copy(std::forward<Alloc>(alloc), std::forward<As>(args)...))
	template<class Alloc, class... As> constexpr auto _(priority<5>/**/, Alloc&& alloc, As&&... args) const BOOST_MULTI_DECLRET(std::forward<Alloc>(alloc).alloc_uninitialized_copy(                            std::forward<As>(args)...))
...
class adl_alloc_uninitialized_copy_n_t {
	...
	template<class... As>              constexpr auto _(priority<2>/**/,                    As&&... args) const BOOST_MULTI_DECLRET(                     alloc_uninitialized_copy_n(std::forward<As>(args)...))
...
// #endif
	template<class T, class... As>     constexpr auto _(priority<5>/**/, T&& arg,           As&&... args) const BOOST_MULTI_DECLRET(    std::decay_t<T>::alloc_uninitialized_copy_n(std::forward<T>(arg), std::forward<As>(args)...))
	template<class T, class... As>     constexpr auto _(priority<6>/**/, T&& arg,           As&&... args) const BOOST_MULTI_DECLRET(std::forward<T>(arg).alloc_uninitialized_copy_n(std::forward<As>(args)...))
...
class alloc_uninitialized_fill_n_t {
	template<             class... As> constexpr auto _(priority<1>/**/,                   As&&... args) const BOOST_MULTI_DECLRET(                       xtd::alloc_uninitialized_fill_n(std::forward<As>(args)...))
	template<class Alloc, class... As> constexpr auto _(priority<2>/**/, Alloc&&/*alloc*/, As&&... args) const BOOST_MULTI_DECLRET(                              adl_uninitialized_fill_n(std::forward<As>(args)...))  // NOLINT(cppcoreguidelines-missing-std-forward)
	template<             class... As> constexpr auto _(priority<3>/**/,                   As&&... args) const BOOST_MULTI_DECLRET(                            alloc_uninitialized_fill_n(std::forward<As>(args)...))
	template<class Alloc, class... As> constexpr auto _(priority<4>/**/, Alloc&&  alloc  , As&&... args) const BOOST_MULTI_DECLRET( std::forward<Alloc>(alloc).alloc_uninitialized_fill_n(std::forward<As>(args)...))
