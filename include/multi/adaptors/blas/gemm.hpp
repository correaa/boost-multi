...
// // b_first->size(), a_first->size(), a_count
// b_first->size(), a_count, a_first->size()
// a_first->size(), a_count, b_first->size()
// a_first->size(), b_first->size(), a_count
// a_count, b_first->size(), a_first->size(),
// a_count, a_first->size(), b_first->size()
