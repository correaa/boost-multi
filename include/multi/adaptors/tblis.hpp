...
$CXX - std = c++ 17 - O0 - I / home / correaa / include / tblis - I / home / correaa / tblis / src / external / tci - L / home / correaa / lib - Wl, -rpath = / home / correaa / lib - ltblis $0 - o $0x && $0x && rm $0x;
exit
#endif
...
#include <tuple>
	...
	struct tensor : ::tblis::tblis_tensor {
		...
		explicit tensor(A&& a) : lens_(std::apply([](auto... s) { return std::array<::tblis::len_type, D>{s...}; }, sizes(a))),
