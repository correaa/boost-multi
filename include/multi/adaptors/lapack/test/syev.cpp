...
`#nvcc - x cu-- expt - relaxed - constexpr`$CXX - D_TEST_MULTI_ADAPTORS_LAPACK_SYEV $0 - o $0x `pkg - config-- libs blas lapack` - lboost_unit_test_framework - lcudart - lcusolver&& $0x&& rm $0x;
exit
#endif
