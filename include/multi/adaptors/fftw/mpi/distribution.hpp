...
$CXXX $CXXFLAGS - O2 - g `mpicxx - showme : compile | sed 's/-pthread/ /g'` - I$HOME / prj / alf $0 - o $0x `mpicxx - showme : link | sed 's/-pthread/ /g'` - lfftw3 - lfftw3_mpi - lboost_timer&& mpirun - n 4 $0x;
exit
#endif
	...
	class many {
	 ...
	 public:
		...
		bool              operator==(many const& other) const {
                                                                                                                                                                                                                                                                                                         return std::tie(this->local_count_, this->local_n0_, this->local_0_start_) == std::tie(other.local_count_, other.local_n0_, other.local_0_start_);
		}
	...
	class many_transposed {
	 ...
	 public:
		...
		bool              operator==(many_transposed const& other) const {
                                                                                                                                                                                                                                                                                                         return std::tie(this->local_count_, this->local_n0_, this->local_0_start_, this->local_n1_, this->local_1_start_) == std::tie(other.local_count_, other.local_n0_, other.local_0_start_, other.local_n1_, other.local_1_start_);
		}
