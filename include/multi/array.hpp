...
struct array<T, 0, Alloc> : static_array<T, 0, Alloc> {
	...
	// NOLINTNEXTLINE(runtime/operator)
	constexpr auto operator&() && -> array* = delete;  // NOLINT(google-runtime-operator) : delete operator&& defined in base class to avoid taking address of temporary  //NOSONAR
...
struct array : static_array<T, D, Alloc> {
	...
	// NOLINTNEXTLINE(runtime/operator)
	HD constexpr auto operator&() && -> array* = delete;  // NOLINT(google-runtime-operator) : delete operator&& defined in base class to avoid taking address of temporary  //NOSONAR
	// NOLINTNEXTLINE(runtime/operator)
	HD constexpr auto operator&() & -> array* { return this; }  // NOLINT(google-runtime-operator) : delete operator&& defined in base class to avoid taking address of temporary  //NOSONAR
	// NOLINTNEXTLINE(runtime/operator)
	HD constexpr auto operator&() const& -> array const* { return this; }  // NOLINT(google-runtime-operator) : delete operator&& defined in base class to avoid taking address of temporary  //NOSONAR
