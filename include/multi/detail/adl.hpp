...
//  template<class... As>                  constexpr auto _(priority<2>/**/, As&&... args                        ) const DECLRETURN(thrust::               uninitialized_copy(std::forward<As>(args)...                        ))
	...
	template<class T,         class... As> constexpr auto _(priority<5>/**/, T&& first, As&&... args             ) const DECLRETURN(std::decay_t<T>::      uninitialized_copy(std::forward<T>(first), std::forward<As>(args)...))
	template<class T,         class... As> constexpr auto _(priority<6>/**/, T&& first, As&&... args             ) const DECLRETURN(std::forward<T>(first).uninitialized_copy(std::forward<As>(args)...                        ))
