...
class range {
 ...
 public:
	...
	template<class Range, decltype(detail::implicit_cast<IndexType>(std::declval<Range&&>().first()),
	...
	template<class Range, decltype(detail::explicit_cast<IndexType>(std::declval<Range&&>().first()),
