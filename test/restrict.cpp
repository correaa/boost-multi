...
auto main() -> int {
	{
		...
		auto const R5 = multi::restrict([](auto ii, auto jj) { return ii + jj; }, multi::extensions_t<2>{2, 3});
		auto const R6 = multi::restrict([](auto ii, auto jj) { return ii + jj; }, multi::extensions_t{2, 3});
		auto const R7 = multi::restrict<2>([](auto ii, auto jj) { return ii + jj; }, {2, 3});
