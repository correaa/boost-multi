...
constexpr auto extensions_bma(BoostMultiArray const& arr, std::index_sequence<I...> /*012*/) {
	return boost::multi::extensions_t<BoostMultiArray::dimensionality>( boost::multi::iextension{static_cast<multi::index>(0), static_cast<multi::index>(arr.shape()[I])} ...);  // NOLINT(cppcoreguidelines-pro-bounds-pointer-arithmetic)
}
