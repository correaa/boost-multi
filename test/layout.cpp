...
//  BOOST_TEST(( extension(arr) == multi::index_extension{0, 50} ));
//  BOOST_TEST(( extension(arr) == multi::iextension{0, 50}      ));
//  // BOOST_TEST(( extension(arr) == multi::irange{0, 50} ));
// }
...
// //  BOOST_TEST( std::get<2>(std::get<0>(t123)) == std::string{"10"} );
// //  }
