...
```
and the elements, when retrived by their coordinates (indices) are such that, for example: `A1D[1] == 'b'`, `A2D[1][0] == 'i'` and `A3D[1][0][2] == 'u'` (or, in C++23, `A2D[i, j]` and `A3D[1, 0, 2]`)
