...
Simple loops can be mapped as well, taking into account indexing differences (C++ version on the rigth):
```fortran
...
> **Thanks** to Joaquín López Muñoz and Andrzej Krzemienski for the critical reading of the documentation, to Sean Parent for inspiring ideas, and especially to Matt Borland for his help integrating the Boost infraestructure to the unit tests.
